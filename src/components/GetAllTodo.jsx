              ...
              todos.map((todo, index) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    {/* Checkbox Button */}
                    <button onClick={() => singleUpdate(todo._id , todo.completed)}
                      disabled={todo.completed}
                      className={`flex-shrink-0 w-6 h-6 rounded-full border-2 
              flex items-center justify-center group self-start sm:mt-1
              transition-all duration-200 
              ${
                todo.completed
                  ? "border-green-500 bg-green-100 cursor-not-allowed opacity-60"
                  : "border-purple-400 hover:border-purple-600 hover:bg-purple-50 cursor-pointer"
              }`}
                    >
                      {todo.completed && (
                    ...
                    <div className="flex sm:flex-col items-center sm:items-end gap-3 sm:gap-2 flex-shrink-0">
                      ...
                      <div className="flex gap-5">
                        <button
                          ...
                          className=" hover:cursor-pointer group relative bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-lg font-medium shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95 transition-all duration-200 flex items-center space-x-2"
                        >
                          <span>Delete</span>
                        </button>
                        <button
                          ...
                          className= {`
                            ...
                            hover:cursor-pointer group relative bg-gradient-to-r from-green-500 to-green-500 text-white px-4 py-2 rounded-lg font-medium shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95 transition-all duration-200 flex items-center space-x-2`}
                        >
                          <span>Update</span>
                        </button>
                      </div>
