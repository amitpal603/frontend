          ...
          <div className="inline-flex items-center bg-white rounded-full px-6 py-3 shadow-lg animate-scale-in">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-2xl font-bold text-gray-800">{todos?.length || 0}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {todos && todos.length > 0 ? (
            todos.map((todo, index) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                  {/* Checkbox Button */}
                  <button onClick={() => singleUpdate(todo._id , todo.completed)} className="flex-shrink-0 w-6 h-6 rounded-full border-2 border-purple-400 hover:border-purple-600 hover:bg-purple-50 transition-all duration-200 flex items-center justify-center group self-start sm:mt-1">
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end gap-3 sm:gap-2 flex-shrink-0">
                    ...
                    <button onClick={() => navigate('/create')}  className="  group relative bg-gradient-to-r from-green-500 to-green-500 text-white px-4 py-2 rounded-lg font-medium shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95 transition-all duration-200 flex items-center space-x-2">
            ...
            <div className="text-center py-16 animate-fade-in">
              <div className="inline-block bg-white rounded-2xl p-12 shadow-xl">
                ...
                <p className="text-gray-500">Start by creating your first task!</p>
              </div>
            </div>
          )}
        </div>
