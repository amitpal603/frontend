    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="text-center mb-12 animate-fade-in">
        <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 tracking-tight">
          <span className="text-gradient">Active Missions</span>
        </h1>
          ...
          {ActiveTask && ActiveTask.length > 0 ? (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                  ...
                  <button 
                    ...
                    className="flex-shrink-0 w-8 h-8 rounded-xl border-2 border-slate-600 hover:border-brand-primary flex items-center justify-center transition-all duration-300 group-hover:scale-110"
                  >
                    {todo.completed && <IoCheckmarkDone className="text-xl text-emerald-400" />}
                  </button>

                  {/* Content Section */}
                  <div className="flex-grow min-w-0">
                    <h2 className="text-white text-2xl font-bold mb-2 break-words leading-tight">
                      {todo.title}
                    </h2>
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end gap-4 flex-shrink-0">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="p-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 transition-all duration-300"
                        title="Edit Mission"
                      >
            ...
            <div className="text-center py-20 animate-fade-in">
              <div className="inline-block glass-card rounded-3xl p-16 border-dashed border-2 border-white/10">
                ...
                <h3 className="text-3xl font-black text-white mb-3">No Active Missions</h3>
                <p className="text-slate-400 font-medium max-w-xs mx-auto">All scheduled objectives have been cleared or not yet initiated.</p>
              </div>
            </div>
          )}
        </div>
